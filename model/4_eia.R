...
persist.mutfit <- function(mu_mv=0.1            # mutant virus 
...
beta_m<-seq(10^-10,10^-5,10^-8)  # range of values for mutant virus probabillity of susceptible cell infection

test <- sapply(beta_m,function(y){
